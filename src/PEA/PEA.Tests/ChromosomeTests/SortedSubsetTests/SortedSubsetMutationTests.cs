...
namespace Pea.Tests.ChromosomeTests.SortedSubsetTests
{
    public class SortedSubsetMutationTests
    {
        ...
        public void GivenChromosome_WithConflict_WhenReplaceOneGene_ThenShouldBeReplaceConflicted()
        {
            ...
            var parameterSet = new ParameterSet();
            parameterSet.SetValue(Chromosome.ParameterNames.ConflictReducingProbability, 0.6, ParameterSource.UserSetting);
            parameterSet.SetValue(Chromosome.ParameterNames.FailedMutationRetryCount, 0, ParameterSource.UserSetting);
